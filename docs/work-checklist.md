...
- [ ] Create item compendiums for new powers, gear, qualities, rituals, or other rules objects.
...
- [ ] Convert Giant relics into Part-Time Gods item data after confirming the live schema.
...
- [ ] Publish `dist/module.json` and `dist/ptg2e-mystic-echoes-vol1-0.1.0.zip` to GitHub release `v0.1.0`.
